# Lab 2-2 Filter 逻辑计划实现

在 Lab 2-1 中,我们实现了 Expand 和 Project 执行器。本实验将进入查询处理层,学习如何将 GQL 查询语句转换为可执行的查询计划。

Lab 2-2 聚焦于 **Filter 逻辑计划节点的生成**,这是支持 `WHERE` 子句的基础。
...
pub fn plan_match_statement(&self, statement: BoundMatchStatement) -> PlanResult<PlanNode> {
    match statement {
        BoundMatchStatement::Simple(binding) => {
            ...
            // ============================================================
            // LAB 2-2 TODO: Add Filter node support
            // ============================================================
            //
...
完成 Lab 2-2 后,你已经掌握了逻辑计划的基本生成方法。
